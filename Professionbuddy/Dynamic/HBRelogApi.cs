    ...
    public class HBRelogApi
    {
        ...
        public HBRelogApi()
        {
            ...
            if (_hbRelogHelperAsm != null)
            {
                ...
                // IsConnected
                var propertyInfo = apiType.GetProperty("IsConnected", BindingFlags.Public | BindingFlags.Static);
                ...
                _currentProfileName = (Func<string>)Delegate.CreateDelegate(typeof(Func<string>), propertyInfo.GetGetMethod());
                // RestartWow
                var methodInfo = apiType.GetMethod("RestartWow", BindingFlags.Public | BindingFlags.Static);
                ...
                _idleProfile = (Action<string, TimeSpan>)Delegate.CreateDelegate(typeof(Action<string, TimeSpan>), methodInfo);
                // GetProfileStatus
        ...
        /// </summary>
        public bool IsConnected { get { return _isConnected != null && _isConnected(); } }

        Func<string> _currentProfileName;
        /// <summary>
        /// Name of the current HBRelog profile (the one that is managing current Honorbuddy instance)
        /// </summary>
        public string CurrentProfileName { get { return _currentProfileName != null ? _currentProfileName() : String.Empty; } }
        Action _restartWow;
        /// <summary>
        /// Restarts the Wow process as well as Honorbuddy.
        /// </summary>
        public void RestartWow() { if (_restartWow != null) _restartWow(); }

        Action _restartHB;
        /// <summary>
        /// Restarts Honorbuddy.
        /// </summary>
        public void RestartHB() { if (_restartHB != null) _restartHB(); }

        Func<string[]> _getProfileNames;
        /// <summary>
        /// Returns an array of all the HBRelog profile names 
        /// </summary>
        /// <returns>Array of HBRelog profile names</returns>
        public string[] GetProfileNames() { return _getProfileNames != null ? _getProfileNames() : new string[] { }; }

        Action<string> _startProfile;
        /// <summary>
        /// Starts a HBRelog profile
        /// </summary>
        /// <param name="profileName">Name of the profile</param>
        public void StartProfile(string profileName) { if (_startProfile != null) _startProfile(profileName); }

        Action<string> _stopProfile;
        /// <summary>
        /// Stops a HBRelog profile
        /// </summary>
        /// <param name="profileName">Name of the profile</param>
        public void StopProfile(string profileName) { if (_stopProfile != null) _stopProfile(profileName); }

        Action<string> _pauseProfile;
        /// <summary>
        /// Pauses a HBRelog profile
        /// </summary>
        /// <param name="profileName">Name of the profile</param>
        public void PauseProfile(string profileName) { if (_pauseProfile != null) _pauseProfile(profileName); }

        Action<string, TimeSpan> _idleProfile;
        /// <summary>
        ...
        public void IdleProfile(string profileName, TimeSpan time) { if (_idleProfile != null) _idleProfile(profileName, time); }

        Func<string, int> _getProfileStatus;
        /// <summary>
        ...
        Action<string> _setProfileStatusText;
        /// <summary>
        /// Sets the current HBRelog profiles status text
        /// </summary>
        /// <param name="status">Status text</param>
        public void SetProfileStatusText(string status) { if (_setProfileStatusText != null) _setProfileStatusText(status); }
        /// <summary>
        /// Re-opens wow and logs on a character
        /// </summary>
        /// <param name="character">Name of character</param>
        public void Logon(string character) { Logon(character, null, null, null, null); }
        /// <summary>
        /// Re-opens wow and logs on a character
        /// </summary>
        /// <param name="character">Name of character</param>
        /// <param name="server">Name of server</param>
        public void Logon(string character, string server) { Logon(character, server, null, null, null); }
        /// <summary>
        /// Re-opens wow and logs on a character
        /// </summary>
        /// <param name="character">Name of Character</param>
        ...
        delegate void LogonDelegate(string character, string server, string customClass, string botBase, string profilePath);
    }
}
